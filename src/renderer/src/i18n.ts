...
const zhCN = {
	...
	"app.composerEnterPlaceholder": "输入消息，Enter 发送。/ 命令，@ 文件，! shell",
	...
	"app.composerShortcutPlaceholder": "输入消息，按设置的快捷键发送。/ 命令，@ 文件，! shell",
	...
	"app.messageDeliverySteerTitle": "steer：当前工具调用后、下一次 LLM 调用前生效",
	"app.modelPickerEmpty": "没有匹配的模型",
	"app.modelPickerSearch": "搜索模型、Provider 或 ID",
...
const enUS: Record<TranslationKey, string> = {
	...
	"app.composerEnterPlaceholder": "Type a message. Enter sends. / commands, @ files, ! shell",
	...
	"app.composerShortcutPlaceholder": "Type a message. Use your shortcut to send. / commands, @ files, ! shell",
	"app.composerSilentPlaceholder": "!!command - run directly without adding context",
	...
	"app.messageDeliverySteerTitle": "steer: applies after the current tool call and before the next LLM call",
	...
	"app.emptyHasProject": "Create an agent to start chatting.",
