...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "settings.wsl.enable": "启用 WSL fallback",
  "settings.wsl.enableDesc": "开启后直接使用 WSL 中的 pi，不再走 Windows 检测。",
  "settings.wsl.distro": "WSL 发行版",
  "settings.wsl.user": "WSL 用户名",
  "settings.wsl.detectHint": "开启后将在检测环境或启动 Agent 时直接使用 wsl -d <distro> -u <user> pi。",
  "settings.wsl.howToGetDistro": "在 Windows 终端运行：wsl -l -v，列表中 NAME 列就是发行版名称。",
  "settings.wsl.howToGetUser": "先在 Windows 终端执行：wsl -d <发行版> -u <你填写的用户名> whoami，验证用户名是否正确。",
  "settings.wsl.warning": "如果发行版或用户名填写不正确，pi 可能无法正确加载 WSL 中的配置、项目和会话文件。",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.wsl.enable": "Enable WSL fallback",
  "settings.wsl.enableDesc": "When enabled, use pi from WSL directly instead of Windows detection.",
  "settings.wsl.distro": "WSL distro",
  "settings.wsl.user": "WSL username",
  "settings.wsl.detectHint": "When enabled, environment checks and agent startup will directly use wsl -d <distro> -u <user> pi.",
  "settings.wsl.howToGetDistro": "Run in Windows terminal: wsl -l -v. The NAME column is your distro.",
  "settings.wsl.howToGetUser": "Run in Windows terminal: wsl -d <distro> -u <your username> whoami to verify the username.",
  "settings.wsl.warning": "If the distro or username is incorrect, pi may fail to load configs, projects, or session files from WSL.",
